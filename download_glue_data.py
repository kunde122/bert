...
def set_args(args):
  BERT_BASE_DIR='//bert_models/2018_10_18/uncased_L-12_H-768_A-12'
  args.input_file='./sample_text.txt'
  args.output_file='/tmp/tf_examples.tfrecord'
  args.vocab_file=BERT_BASE_DIR+'/vocab.txt'
